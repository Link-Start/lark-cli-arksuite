...
lark-cli wiki +delete-space --space-id "https://example.larkoffice.com/wiki/MZVawuYu2ioJVykfKOhcMan7nHe" --yes

# GOOD：先把 URL 解析成真实 space_id，再执行写操作
lark-cli wiki spaces get_node --params '{"token":"MZVawuYu2ioJVykfKOhcMan7nHe"}' --as user --format json   # 读 data.node.space_id
lark-cli wiki +delete-space --space-id 7200260809230548994 --yes
```
